            ...
            <div className="mt-3 grid grid-cols-3 gap-2 sm:grid-cols-2">
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>🛠️</span>
                  <div>
                    <div className="font-semibold">Crear ficha propiedad</div>
              ...
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>▸</span>
                  <div>
                    <div className="font-semibold">Gestión documentos</div>
              ...
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>💬</span>
                  <div>
                    <div className="font-semibold">Consultas inteligentes</div>
              ...
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>✉️</span>
                  <div>
                    <div className="font-semibold">Email automatizado</div>
              ...
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>📊</span>
                  <div>
                    <div className="font-semibold">Resúmenes automáticos</div>
              ...
              <div className="h-[48px] rounded-[12px] border border-[color:var(--c-green-200)] bg-white text-left px-3 py-2 text-sm shadow-sm">
                <div className="flex items-center gap-2">
                  <span>⚠️</span>
                  <div>
                    <div className="font-semibold">Recordatorios</div>
